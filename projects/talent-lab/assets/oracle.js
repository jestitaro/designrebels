...
(function () {
  ...
  var AREAS = [
    { title: 'Estandarización de componentes', dept: 'Producto', deptKey: 'producto', deptClass: 'dept-producto-ux', tags: ['orden', 'reutilizar'],
      mission: 'Tu misión es que nadie tenga que inventar la rueda dos veces: cada componente que ordenás hoy ahorra horas mañana.' },
    { title: 'Testing automatizado', dept: 'Producto', deptKey: 'producto', deptClass: 'dept-producto-ux', tags: ['detectar', 'automatizar'],
      mission: 'Tu misión es atrapar los errores antes de que lleguen a alguien más — la calma de saber que algo se probó solo.' },
    { title: 'Documentación técnica y funcional', dept: 'Producto', deptKey: 'producto', deptClass: 'dept-producto-ux', tags: ['explicar', 'orden'],
      mission: 'Tu misión es que el conocimiento no viva solo en la cabeza de una persona.' },
    { title: 'Calidad de código y code review', dept: 'Producto', deptKey: 'producto', deptClass: 'dept-producto-ux', tags: ['detectar', 'orden'],
      mission: 'Tu misión es que el código de hoy no sea el dolor de cabeza de mañana.' },
    { title: 'DevOps, CI-CD y ambientes', dept: 'Producto', deptKey: 'producto', deptClass: 'dept-producto-ux', tags: ['automatizar', 'simplificar'],
    ...
    { title: 'Onboarding de nuevos', dept: 'Recursos Humanos', deptKey: 'rrhh', deptClass: 'dept-personas-cultura', tags: ['cuidar', 'explicar'],
      mission: 'Tu misión es que nadie se sienta perdido en su primera semana.' },
    { title: 'Cultura y clima de equipo', dept: 'Recursos Humanos', deptKey: 'rrhh', deptClass: 'dept-personas-cultura', tags: ['cuidar'],
      mission: 'Tu misión es que venir a trabajar se sienta bien, no solo se tolere.' },
    { title: 'Formación interna', dept: 'Recursos Humanos', deptKey: 'rrhh', deptClass: 'dept-personas-cultura', tags: ['explicar', 'cuidar'],
      mission: 'Tu misión es que lo que ya sabe alguien del equipo, lo termine sabiendo todo el equipo.' },
    { title: 'Procesos de venta y pipeline', dept: 'Comercial', deptKey: 'comercial', deptClass: 'dept-comercial-clientes', tags: ['vender', 'datos'],
      mission: 'Tu misión es que ninguna oportunidad se pierda por el camino.' },
    { title: 'Material comercial y demos', dept: 'Comercial', deptKey: 'comercial', deptClass: 'dept-comercial-clientes', tags: ['vender', 'contar'],
      mission: 'Tu misión es que el producto se explique solo, con la ayuda justa.' },
    { title: 'Éxito y relación con clientes', dept: 'Comercial', deptKey: 'comercial', deptClass: 'dept-comercial-clientes', tags: ['acompanar', 'cuidar'],
      mission: 'Tu misión es que el cliente se quede no por costumbre, sino porque de verdad lo cuidan.' },
    { title: 'Análisis funcional y diseño', dept: 'Producto', deptKey: 'producto', deptClass: 'dept-producto-ux', tags: ['visual', 'datos'],
      mission: 'Tu misión es traducir lo que el negocio necesita a algo que se pueda construir de verdad.' },
    { title: 'Performance frontend / backend', dept: 'Producto', deptKey: 'producto', deptClass: 'dept-producto-ux', tags: ['visual', 'automatizar'],
      mission: 'Tu misión es que nada se sienta lento, aunque nadie note por qué.' },
    { title: 'Arquitectura modular y reutilización', dept: 'Producto', deptKey: 'producto', deptClass: 'dept-producto-ux', tags: ['reutilizar', 'orden'],
      mission: 'Tu misión es construir una sola vez lo que se va a usar muchas.' },
    { title: 'Seguridad técnica básica', dept: 'Producto', deptKey: 'producto', deptClass: 'dept-producto-ux', tags: ['detectar'],
      mission: 'Tu misión es cuidar lo que nadie ve hasta que falla.' },
    { title: 'Experiencia de desarrollador (DX)', dept: 'Producto', deptKey: 'producto', deptClass: 'dept-producto-ux', tags: ['simplificar', 'explicar'],
      mission: 'Tu misión es eliminar las pequeñas frustraciones que frenan a quienes construyen nuestros productos.' },
    { title: 'Datos, métricas y reporting', dept: 'Producto', deptKey: 'producto', deptClass: 'dept-producto-ux', tags: ['datos'],
