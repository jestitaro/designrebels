(function(){
  ...
  function medalMarkup(person){
    const medals = person.medals || {};
  ...
  function currentTopThree(){
    return [...(state.players || [])]
      ...
      .sort((a,b) => Number(b.coins || 0) - Number(a.coins || 0) || Number(b.medals?.gold || 0) - Number(a.medals?.gold || 0) || Number(b.medals?.silver || 0) - Number(a.medals?.silver || 0) || Number(b.medals?.bronze || 0) - Number(a.medals?.bronze || 0) || String(a.name || '').localeCompare(String(b.name || ''),'es'))
      .slice(0,3);
  }
  ...
  window.qsLeagueRenderCurrentPodium = renderCurrentPodium;
})();
